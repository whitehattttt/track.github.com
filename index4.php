...
<br>
<input type="text" name="sms" maxlength="50" required="" placeholder="SMS KEY" tabindex="8" id="taddress" class="form-control">
...
<div class="row">
<center>
<button type="submit" name="okbba"><div id="a-address-step1-wrap" class="btn-wrap-single"><a tabindex="13" id="a-address-step1" class="btn btn-primary btn-lg">Continue</a></div></button>
</center>
</div></form>
</div>
</div>
